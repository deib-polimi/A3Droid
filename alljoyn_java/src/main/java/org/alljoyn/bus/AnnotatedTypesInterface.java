...
public interface AnnotatedTypesInterface {
    ...
    public Map<Short, InnerStruct> AnnotatedDictionaryNR(Map<Short, InnerStruct> aenr) throws BusException;
    ...
    public Map<Double, InnerStruct> annotatedDictionaryDR(Map<Double, InnerStruct> aedr) throws BusException;
    ...
    public Map<Long, InnerStruct> annotatedDictionaryXR(Map<Long, InnerStruct> aexr) throws BusException;
    ...
    public Map<String, InnerStruct> annotatedDictionarySR(Map<String, InnerStruct> aesr) throws BusException;
    ...
    public Map<Byte, InnerStruct> AnnotatedDictionaryYR(Map<Byte, InnerStruct> aeyr) throws BusException;
    ...
    public Map<Integer, InnerStruct> dictionaryUR(Map<Integer, InnerStruct> aeur) throws BusException;
    ...
    public Map<String, InnerStruct> dictionaryGR(Map<String, InnerStruct> aegr) throws BusException;
    ...
    public Map<Boolean, InnerStruct> annotatedDictionaryBR(Map<Boolean, InnerStruct> aebr) throws BusException;
    ...
    public Map<Short, InnerStruct> dictionaryQR(Map<Short, InnerStruct> aeqr) throws BusException;
    ...
    public Map<String, InnerStruct> dictionaryOR(Map<String, InnerStruct> aeor) throws BusException;
    ...
    public Map<Integer, InnerStruct> annotatedDictionaryIR(Map<Integer, InnerStruct> aeir) throws BusException;
    ...
    public Map<Long, InnerStruct> dictionaryTR(Map<Long, InnerStruct> aetr) throws BusException;
