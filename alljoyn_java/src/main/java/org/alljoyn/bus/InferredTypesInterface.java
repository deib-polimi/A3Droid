...
public interface InferredTypesInterface {
    ...
    public Map<Byte, InnerStruct> inferredDictionaryYR(Map<Byte, InnerStruct> aeyr) throws BusException;
    ...
    public Map<Boolean, InnerStruct> inferredDictionaryBR(Map<Boolean, InnerStruct> aebr) throws BusException;
    ...
    public Map<Short, InnerStruct> inferredDictionaryNR(Map<Short, InnerStruct> aenr) throws BusException;
    ...
    public Map<Integer, InnerStruct> inferredDictionaryIR(Map<Integer, InnerStruct> aeir) throws BusException;
    ...
    public Map<Long, InnerStruct> inferredDictionaryXR(Map<Long, InnerStruct> aexr) throws BusException;
    ...
    public Map<Double, InnerStruct> inferredDictionaryDR(Map<Double, InnerStruct> aedr) throws BusException;
    ...
    public Map<String, InnerStruct> inferredDictionarySR(Map<String, InnerStruct> aesr) throws BusException;
